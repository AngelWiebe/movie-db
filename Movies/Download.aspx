<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Download.aspx.cs" Inherits="Movies.Download" %>
    ...
    <table>
        <tr>
            <td class="auto-style4">
                <asp:DropDownList ID="ddlMovies" runat="server" Height="44px" Width="163px"></asp:DropDownList>
            </td>
        ...
        <tr>
            ...
            <td></td>
            <td>
                <asp:ListBox ID="lbDownload" runat="server" Height="153px" Width="272px"></asp:ListBox>
            </td>
            <td>
